...
export default function VideoyaFiligranPage() {
  ...
  const handleConvert = useCallback(async () => {
    if (!videoFile || !imageFile) {
      setError("Video ve filigran görseli yükleyin.");
      return;
    }
    ...
    <div className="relative min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <main className="relative px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 text-slate-600 dark:text-slate-400">Videonuza sağ alt köşede filigran (logo) ekleyin.</p>
            ...
            {state === "idle" || state === "ready" ? (
              <>
                <div className="grid w-full max-w-md gap-4">
                  ...
                  <div>
                    <label className="mb-1 block text-sm font-medium text-slate-600 dark:text-slate-400">Filigran (görsel)</label>
